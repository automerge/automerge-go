...
cp "$deps/build/aarch64-apple-darwin/release/libautomerge.dylib" "$deps/darwin_arm64/"
cp "$deps/build/x86_64-apple-darwin/release/libautomerge.dylib" "$deps/darwin_amd64/"
