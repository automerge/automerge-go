 ...
 * src must be a byte array of size `>= count`
 */
struct AMresult *AMlistPutBytes(struct AMdoc *doc, const struct AMobjId *obj_id, size_t index, bool insert, struct AMbyteSpan val);
 ...
 * src must be a byte array of size `>= count`
 */
struct AMresult *AMmapPutBytes(struct AMdoc *doc, const struct AMobjId *obj_id, struct AMbyteSpan key, struct AMbyteSpan val);
